...
public class EmissionController {
    ...
    // 4b. FORMULAR ZUM BEARBEITEN
    @GetMapping("/bearbeiten/{id}")
    public String bearbeitenForm(@PathVariable("id") Long id, Model model) {
        Emission emission = emissionService.findById(id); 
        // Wenn findById hier NULL zurückgibt, kracht es im HTML!
